...
[pantor/inja](https://github.com/pantor/inja) `v3.5.0`), commit `121afc9` (2026-08-12) - copied
from that repo's `single_include/inja/inja.hpp`. The fork adds `{% filter %}...{% endfilter %}`
...
that) and copy it over this file, then update the commit hash above.
